...
class AdminController extends UserController
{
    ...
    /**
     * 获取活跃转化统计数据（基于class_expire字段）
     * @param $request
     * @param $response
     * @param $args
     * @return mixed
     */
    public function getConversionStats($request, $response, $args)
    {
        try {
            $stats = new Analytics();
            $data = $stats->getConversionStats();
            ...
            \error_log('getConversionStats Controller error: ' . $e->getMessage());
