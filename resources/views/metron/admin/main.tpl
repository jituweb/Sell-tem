            ...
            <ul class="nav">
                <li>
                    ...
                    <ul class="menu-collapse collapse in" id="ui_menu_me">
                        ...
                        <li><a href="/admin/link/token"><i class="icon icon-lg">flash_auto</i>&nbsp; Token 查询</a></li>
                        <li><a href="/admin/user_traffic"><i class="icon icon-lg">flash_auto</i>&nbsp; 每日查询</a></li>
                    </ul>
                    ...
                    <ul class="menu-collapse collapse in" id="ui_menu_node">
                        ...
                        <li><a href="/admin/node_online"><i class="icon icon-lg">dialer_sip</i>&nbsp;节点在线人数</a></li>
