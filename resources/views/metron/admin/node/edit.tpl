                            ...
                            <div class="card">
                                <div class="card-main">
                                    <div class="card-inner">
                                        ...
                                        <div class="form-group form-group-label">
                                            <label class="floating-label" for="server_client">客户端专用节点域名（可选）</label>
                                            <input class="form-control maxwidth-edit" id="server_client" name="server_client" type="text"
                                                   value="{$node->server_client}">
                                            <p class="form-control-guide">
                                                <i class="material-icons">info</i>留空则使用默认节点地址
                                            </p>
                                            <p class="form-control-guide">
                                                <i class="material-icons">info</i>官方客户端将使用此域名，第三方客户端使用默认节点地址
                                            </p>
                                        </div>
        ...
        submitHandler: () => {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    server_client: $$getValue('server_client'),
