                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row p-5">
                                                    <div class="col-sm-12 col-md-12 col-lg-7 pb-5">
                                                        ...
                                                        <a href="https://45.62.102.54:12598/jitu/SSTAP.exe" class="btn btn-pill btn-sstap mb-4" target="_blank">&nbsp;&nbsp;<i class="metron-sstap text-white"></i>下载 SSTap 客户端</a>
                                                ...
                                                <div class="row p-5">
                                                    <div class="col-sm-12 col-md-12 col-lg-7 pb-5">
                                                        ...
                                                        <div class="btn-group mb-3 mr-3">
                                                            <button type="button" class="btn btn-pill btn-sstap ssr-force-http-copy" data-ssr-url="{$subInfo["ssr"]}">&nbsp;&nbsp;<i class="metron-ssr1 text-white"></i>复制 SSTap 订阅&nbsp;&nbsp;</button>

                                                        </div>
                                                        <p class="mb-2">右键任务栏图标 <code>SSR订阅</code> - <code>SSR订阅管理</code></p>
                                                        <p class="mb-2">将订阅地址粘贴到 <code>URL</code> 一栏,<code>并点击添加</code></p> <h6>由于sstap客户端太老，不支持新版ssl，请把订阅地址里面的https后面的s删除后在点添加，不删除s无法获取到节点，请务必操作</h6>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.ssr-force-http-copy').forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            if (window.$ && $.notify) {
                $.notify({
                    message: 'SSR 订阅链接已复制（已自动适配 SSTap）'
                }, {
                    type: 'success',
                    delay: 2000,
                    placement: {
