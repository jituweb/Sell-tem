                                                        ...
                                                        <div class="card-body pb-0 pl-0">
                                                            <div class="flex-grow-1 card-spacer-x">
                                                                ...
                                                                <div class="d-flex align-items-center justify-content-between mb-5">
                                                                    ...
                                                                    <a href="{$c_w['down']}" class="btn btn-primary font-weight-bold btn-pill" target="_blank">下载地址1</a>
                                                                    <a href="https://ajiro.infini-cloud.net/share/1311512df6227b26" class="btn btn-primary font-weight-bold btn-pill" target="_blank">下载地址2</a>
                                                                </div>
                                                                {if !$c_w@last}
                                                        ...
                                                        <div class="card-body pb-0 pl-0">
                                                            <div class="flex-grow-1 card-spacer-x">
                                                                ...
                                                                <div class="d-flex align-items-center justify-content-between mb-5">
                                                                    ...
                                                                    <a href="{$c_w['down']}" class="btn btn-primary font-weight-bold btn-pill" target="_blank">下载地址1</a>
                                                                     <a href="https://ajiro.infini-cloud.net/share/1311cb5370b18932" class="btn btn-primary font-weight-bold btn-pill" target="_blank">下载地址2</a>
                                                                </div>
                                                                {if !$c_w@last}
                                                                <div class="separator separator-dashed mb-5"></div>
                                                                {/if}
                                                        ...
                                                        <div class="card-body pb-0 pl-0">
                                                            <div class="flex-grow-1 card-spacer-x">
                                                                ...
                                                                <div class="d-flex align-items-center justify-content-between mb-5">
                                                                    ...
                                                                    <a href="{$c_w['down']}" class="btn btn-primary font-weight-bold btn-pill" target="_blank">下载地址1</a>
                                                                    <a href="https://ajiro.infini-cloud.net/share/13113e23daa2bfe5" class="btn btn-primary font-weight-bold btn-pill" target="_blank">下载地址2</a>
                                                                </div>
                                                                {if !$c_w@last}
                                                                <div class="separator separator-dashed mb-5"></div>
                                                                {/if}
