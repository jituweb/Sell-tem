...
return function (SlimApp $app) {
    ...
    $app->group('/user', function () {
        ...
        $this->get('/global-nav', App\Controllers\User\GlobalNavController::class . ':index');
    ...
    $app->group('/admin', function () {
        ...
        $this->get('/api/analytics/conversion_stats', App\Controllers\AdminController::class . ':getConversionStats');
    ...
    $app->get('/admin/node_online', App\Controllers\Admin\NodeOnlineController::class . ':index')->setName('admin.node_online');
    $app->get('/admin/link/token', 'App\Controllers\Admin\LinkController:tokenIndex');
    $app->post('/admin/link/token', 'App\Controllers\Admin\LinkController:tokenQuery');
    $app->get('/admin/user_traffic', 'App\Controllers\Admin\UserTrafficController:index');
    ...
    $app->get('/authorization', App\Controllers\AuthController::class . ':auth');
    $app->get('/shop', App\Controllers\UserController::class . ':shop');
    $app->get('/notice', App\Controllers\UserController::class . ':notice');
};
